        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-techblue transition-colors">
                <FacebookIcon className="w-5 h-5" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-techblue transition-colors">
                <InstagramIcon className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-techblue transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>info@arsynogroup.com</li>
              <li>8910339068</li>
              <li className="leading-relaxed">Plot No. 1, Lovelock Street,<br/>Behind Punjab Club, Ballygunge,<br/>Kolkata, WestBengal, 700019</li>
            </ul>
          </div>
        </div>

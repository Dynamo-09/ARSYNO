...
// Import images
import imgVirtualCFO from '../assets/Vitual CFO.png';
import imgBookkeeping from '../assets/Bookkeeping.png';
import imgFinancialModeling from '../assets/Financial Modeling.png';
import imgTaxStrategy from '../assets/TAX STRATEGY.png';
import imgReporting from "../assets/reporting and KPI's.png";
import imgPayroll from '../assets/Payroll.png';
import imgStrategy from '../assets/Strategy and Advisory.png';
import imgSCM from '../assets/SCM.png';
import imgProcessAutomation from '../assets/Process Automation.png';
import imgTechSupport from '../assets/Technology and software support.png';
          ...
          {detailedServices.map((service, idx) => (
            ...
            >
              ...
              <div className="flex-1 w-full relative">
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200 overflow-hidden relative shadow-xl shadow-gray-200/50 group flex items-center justify-center p-2">
                   <img src={service.image} alt={service.title} className="w-full h-auto object-contain rounded-xl transition-transform duration-700 group-hover:scale-105" />
                   <div className="absolute inset-0 bg-gradient-to-tr from-navy-900/5 to-transparent pointer-events-none" />
                </div>
              </div>
            </motion.div>
          ))}

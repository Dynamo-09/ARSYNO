    ...
    <div className="w-full">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 py-32 md:py-48 flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Accounting <br/> <span className="text-techblue drop-shadow-sm">Beyond Numbers</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto mb-12 font-medium"
          >

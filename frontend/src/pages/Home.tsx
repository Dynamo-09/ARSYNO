import { ArrowRight, BarChart3, Calculator, PiggyBank, Briefcase, FileSpreadsheet, TrendingUp, Lightbulb, Truck, Cpu, Laptop, Bot, Cloud, Building, GraduationCap, HeartPulse, ShoppingCart, CreditCard, Utensils, Sprout, Factory, Leaf, Store } from 'lucide-react';
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {industries.map((industry, idx) => (
              <motion.div 
                ...
                key={idx} 
                className="bg-white/70 backdrop-blur-md border border-gray-100 p-8 rounded-2xl hover:border-techblue/30 transition-colors group shadow-lg shadow-gray-200/50 flex flex-col items-center text-center"
              >
                ...
                <h3 className="text-xl font-bold text-navy-900">{industry.title}</h3>
              </motion.div>
            ))}
          </div>
        </div>

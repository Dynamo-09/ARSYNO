import { ArrowRight, BarChart3, Calculator, PiggyBank, Briefcase, FileSpreadsheet, TrendingUp, Lightbulb, Truck, Cpu, Laptop, Bot, Cloud, Building, GraduationCap, HeartPulse } from 'lucide-react';
...
const industries = [
  ...
  { icon: <HeartPulse />, title: 'Health Care' },
];

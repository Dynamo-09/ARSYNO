  ...
  return (
    <div className="pt-28 pb-20 bg-gray-50 min-h-screen">
      <div className="max-w-[1600px] mx-auto px-6 md:px-10 lg:px-12">
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-navy-900 mb-4 tracking-tight">Our Blog</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogs.map((blog) => (
            <div key={blog.id} className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full hover:shadow-xl transition-shadow duration-300">

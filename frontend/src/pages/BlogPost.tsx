        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-10 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {relatedBlogs.map((relatedBlog) => (
              <div key={relatedBlog.id} className="bg-white/70 backdrop-blur-md border border-gray-100 rounded-2xl shadow-lg shadow-gray-200/50 overflow-hidden flex flex-col h-full hover:border-techblue/30 transition-all duration-300 group cursor-pointer">

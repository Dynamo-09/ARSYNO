            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="w-full">
                  ...
                  <div className="w-full max-w-xs overflow-hidden rounded-xl border border-gray-200 shadow-sm mt-2">
                    <img 
                      src="/images/kolkata_map.png" 
                      alt="Map to Office" 
                    ...
                    <a 
                      ...
                      className="block w-full bg-[#6c91c3] hover:bg-[#5b7fae] text-white text-center text-sm font-semibold py-2 transition-colors"
                    >

          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-navy-50 p-3 rounded-xl border border-gray-200 text-techblue mr-4 shadow-sm">
                  <Mail className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="font-semibold text-lg text-navy-900">Email Us</h3>
                  <p className="text-gray-600">hello@arsyno.com</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="bg-navy-50 p-3 rounded-xl border border-gray-200 text-techblue mr-4 shadow-sm">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Tech Boulevard, Suite 400<br/>San Francisco, CA 94105</p>
                </div>
              </div>
            </div>
          </motion.div>

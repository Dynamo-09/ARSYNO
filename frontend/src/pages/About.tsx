      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        >
          <p className="text-2xl leading-relaxed font-semibold text-navy-900">
            ARSYNO Group was founded on a simple premise: traditional accounting firms are too slow, too opaque, and disconnected from the operational realities of modern businesses.
          </p>
          
          <p>
            We believe that financial data shouldn't just be about compliance and looking backward. It should be a dynamic tool that empowers founders and executives to look forward, make strategic decisions, and drive growth.
          </p>
